...
<head>
    ...
    <title>Christian Rojas- Resume</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">cjrojas.72@rutgers.edu</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="#portfolio">Experience/Education</a>
                    </li>
                    <li class="page-scroll">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name">Christian Rojas</span>
                        <h2>Skills</h2>
                        <hr class="star-light">
                        <span class="skills">HTML, CSS, Javascript, Java, SQL, Drupal7, Bootstrap3 </span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>I love technology, and I especially love web technology. I believe computers and the internet are some of the most important technologies in our lifetime. Because of this I plan 
                    to work with these technologies for the rest of my life.</p>
                </div>
                <div class="col-lg-4">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>Location</h3>
                        <p>318 Maple ave<br>Linden, NJ 07036</p>
                    </div>
                    <div class="footer-col col-md-4">
